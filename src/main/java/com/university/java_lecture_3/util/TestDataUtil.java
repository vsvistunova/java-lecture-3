...
public class TestDataUtil {
    ...
    public static List<Event> createTestEvents() {
        List<User> users_in_the_event = new ArrayList<>();
        List<Event> events = new ArrayList<>();
        events.add(new Event(
            1L,
            "пара 1",
            "test",
            LocalDateTime.parse("2025-10-10T13:45"),
            LocalDateTime.parse("2025-10-10T15:00"),
            "224 кабинет",
            30, users_in_the_event));
        events.add(new Event(
                2L,
                "пара 2",
                "test",
        ...
        events.add(new Event(
                ...
                LocalDateTime.parse("2025-10-10T15:00"),
                "224 кабинет",
                30,users_in_the_event = createTestUsers() ));
        return events;
    }
}
